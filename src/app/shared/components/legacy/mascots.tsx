...
import leekuMascotImg from "../../assets/leeku_mascot.png";
      ...
      case "veeku":
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            <path
              d="M 42 18 L 58 18 L 65 30 L 50 35 L 35 30 Z"
              fill="#10B981"
              opacity="0.3"
              stroke="#10B981"
              strokeWidth="1.5"
            ...
            <path
              d="M 73 55 L 73 50 Q 76 46 79 50 L 79 55"
              fill="none"
              stroke="#10B981"
              strokeWidth="1.5"
            />
      ...
      case "queueku":
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            {/* Speed spikes */}
            <path
              d="M 10 50 L 22 47 L 22 53 Z M 90 50 L 78 47 L 78 53 Z"
              fill="#FBBF24"
            />
            <path
              d="M 50 10 L 47 22 L 53 22 Z M 50 90 L 47 78 L 53 78 Z"
              fill="#FBBF24"
            />
            {/* Big spinny eyes */}
            <circle
            ...
            {/* Lightning bolt */}
            <path
              d="M 48 30 L 56 30 L 46 42 L 54 42 L 44 56"
              fill="none"
              stroke="#FF007F"
              strokeWidth="2"
            />
      ...
      case "quoteku":
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            {/* Squiggly mouth */}
            <path
              d="M 40 66 Q 45 61 50 66 Q 55 71 60 66"
              fill="none"
              stroke="#F97316"
              strokeWidth="3"
              strokeLinecap="round"
      ...
      case "memeku":
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            />
            <polygon
              points="50,15 58,35 80,35 62,48 70,70 50,56 30,70 38,48 20,35 42,35"
              fill="#FFD700"
              stroke="#FF007F"
              strokeWidth="1"
            />
            ...
            {/* Sparkles */}
            <text x="12" y="30" fill="#FF007F" fontSize="12" fontWeight="bold">
              ★
            </text>
            <text x="80" y="75" fill="#00F2FF" fontSize="12" fontWeight="bold">
              ★
            </text>
            {/* smug smirk */}
            <path
              d="M 45 56 Q 52 50 56 56"
              fill="none"
              stroke="#FF007F"
              strokeWidth="3"
              strokeLinecap="round"
...
export function MascotSpeechBubble({
  ...
  const arrowClasses = {
    ...
    bottom:
      "bottom-[-9px] left-1/2 transform -translate-x-1/2 border-r-2 border-b-2 rotate-45",
    left: "left-[-8px] top-1/2 transform -translate-y-1/2 border-l-2 border-b-2 rotate-45",
    right:
      "right-[-8px] top-1/2 transform -translate-y-1/2 border-r-2 border-t-2 rotate-45",
  };

  return (
    <div
      className={`relative ${mascot.bgColor} border-2 ${mascot.borderColor} p-4 font-mono ${className}`}
    >
      <div
        ...
        style={{
          ...
          borderLeft:
            arrowPosition === "left" || arrowPosition === "top"
              ? `2px solid ${mascot.color}`
              : "none",
          borderBottom:
          ...
          borderRight:
            arrowPosition === "right" || arrowPosition === "bottom"
              ...
              : "none",
          borderTop:
            arrowPosition === "top" || arrowPosition === "right"
              ? `2px solid ${mascot.color}`
              : "none",
        }}
      />
